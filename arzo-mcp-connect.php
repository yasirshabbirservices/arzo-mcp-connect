 ...
 * Plugin URI:        https://github.com/yasirshabbirservices/arzo-mcp-connect
...
require_once ARZO_MCP_DIR . 'includes/class-icons.php';
require_once ARZO_MCP_DIR . 'includes/class-adapter.php';
